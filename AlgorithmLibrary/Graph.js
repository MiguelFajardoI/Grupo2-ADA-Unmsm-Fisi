...
Graph.prototype.addControls = function(addDirection)
{
	...
	var radioButtonList = addRadioButtonGroupToAlgorithmBar(["Small Graph"], "GraphSize");
	...
	var radioButtonList = addRadioButtonGroupToAlgorithmBar(["Representación del gráfico", 
